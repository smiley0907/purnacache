...
/**
 * Choose a shard for each insert or delete based on document id hashing. Do NOT
 * use this distribution policy when the number of shards changes.
 */
public class HashingDistributionPolicy implements IDistributionPolicy {
	 ...
	 * (non-Javadoc)
	 * 
	 * @seeorg.apache.hadoop.contrib.index.mapred.IDistributionPolicy#

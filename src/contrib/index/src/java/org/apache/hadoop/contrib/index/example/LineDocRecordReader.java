 ...
 * doc. Each line is as follows: documentID<SPACE>op<SPACE>content<EOF>, where
 * op can be "i", "ins" or "insert" for insert, "d", "del" or "delete" for
 * delete, or "u", "upd" or "update" for update.
 */

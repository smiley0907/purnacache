...
/**
 * A distribution policy decides, given a document with a document id, which one
 * shard the request should be sent to if the request is an insert, and which
 * shard(s) the request should be sent to if the request is a delete.
 */
public interface IDistributionPolicy {
	 ...
	 * distribution policy would send a delete request to all the shards. -1

...
public class TestReflectionUtils extends TestCase {
	...
	private static Class toConstruct[] = { String.class,
			TestReflectionUtils.class, HashMap.class };
	...
	public void testCacheDoesntLeak() throws Exception {
		int iterations = 9999; // very fast, but a bit less reliable - bigger
		// numbers force GC
		for (int i = 0; i < iterations; i++) {
			URLClassLoader loader = new URLClassLoader(new URL[0], getClass()
					.getClassLoader());
			Class cl = Class.forName(
					"org.apache.hadoop.util.TestReflectionUtils$LoadedInChild",
					false, loader);
	 ...
	 * JobConfigurable objects. This should be made deprecated along with the
	 * mapred package HADOOP-1230. Should be removed when mapred package is
	 * removed.
	 */

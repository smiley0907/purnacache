...
/**
 * An implementation of MetricsRecord. Keeps a back-pointer to the context from
 * which it was created, and delegates back to it on <code>update</code> and
 * <code>remove()</code>.
 */
public class MetricsRecordImpl implements MetricsRecord {
	...
	private void setAbsolute(String metricName, Number metricValue) {
		metricTable.put(metricName, new MetricValue(metricValue,
				MetricValue.ABSOLUTE));
	}
